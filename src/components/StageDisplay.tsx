...
const StageDisplay = ({ currentStage, nextStage, remainingTime }: StageDisplayProps) => {
  return (
    <div className="flex flex-col">
      <div className="bg-white border border-dealSim-gray/20 rounded-md p-6 font-medium text-dealSim-navy">
        Stage: <span className="font-bold">{currentStage}</span>
      </div>
      <div className="bg-white border border-dealSim-gray/20 rounded-md mt-1 p-6 font-medium text-dealSim-navy">
